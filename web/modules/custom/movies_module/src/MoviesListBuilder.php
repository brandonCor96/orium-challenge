...
class MoviesListBuilder extends EntityListBuilder {
  ...
  public function buildRow(EntityInterface $entity) {
   ...
   foreach ($genre as $term) {
     $term_entity = \Drupal::entityTypeManager()->getStorage('taxonomy_term')->load($term['target_id']);
    ...
    $row['release_date'] = $this->dateFormatter->format($entity->get('release_date')->value);
